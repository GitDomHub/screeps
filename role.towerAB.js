// copied from https://steamcommunity.com/app/464350/discussions/5/152390014801780540/
// dont include yet!
module.exports = {
    ...
    defendMyRoom: function (myRoomName) {
        ...
        //if there are hostileHealers - attakc them    
        ...
        if (hostiles.length === 0) {
            ...
            // issue: only get creeps in this room!
            //....first heal any damaged creeps
            for (let name in Game.creeps) {
                // get the creep object
                var creep = Game.creeps[name];
                if (creep.hits < creep.hitsMax) {towers.forEach(tower => tower.heal(creep));
            ...
            for (var i in towers) {
                ...
                if (towers.energy >= ((towers.energyCapacity / 2))) {
